...
// Array di processi
const processi = [
    new ProcessoProduzione("Stampe su tessuti riciclati", "I prodotti vengono stampati con disegni personalizzati su tessuti riciclati, utilizzando tecniche di stampa ecologiche per ridurre l'impatto ambientale"),
    new ProcessoProduzione("Cucitura di cappelli", "I cappelli vengono cuciti a mano con materiali sostenibili, come cotone organico o tessuti riciclati, per creare accessori alla moda e rispettosi dell'ambiente"),
];
